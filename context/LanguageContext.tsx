...
export const translations = {
  vi: {
    ...
    soul: {
      ...
      missionPills: ['⚡ Kiến trúc Full-Stack', '🧠 Trí tuệ nhân tạo AI', '📊 Nền tảng Dữ liệu'],
      visionPills: ['🌐 Dẫn đầu Kỹ thuật', '🛡️ Bảo mật Tuyệt đối', '🚀 Giá trị Bền vững'],
      valS: {
        title: 'atisfaction',
    ...
    footer: {
      ...
      taxCode: '0317987804',
      taxLabel: 'Mã số thuế: 0317987804',
    ...
    team: {
      ...
      wwb: {
        ...
        valA: { tag: 'Bình dân hóa công nghệ', desc: 'Chúng tôi tin rằng mọi doanh nghiệp — bất kể quy mô — đều xứng đáng tiếp cận các giải pháp thông minh, hiện đại để tăng tốc tăng trưởng và mở khóa tiềm năng.' },
        valP1: { tag: 'Giải pháp thực chất', desc: 'Chúng tôi tin vào việc xây dựng sản phẩm giải quyết bài toán thực tế, không chỉ đơn thuần tạo ra tính năng.' },
        valT: { tag: 'Minh bạch & Tin cậy', desc: 'Chúng tôi tin vào sự minh bạch, tinh thần hợp tác và kiến tạo niềm tin qua từng tương tác.' },
        valV: { tag: 'Giá trị thực tiễn', desc: 'Chúng tôi tin rằng công nghệ chỉ thực sự ý nghĩa khi tạo ra giá trị đích thực cho con người.' },
        valP2: { tag: 'Đồng hành dài lâu', desc: 'Chúng tôi tin vào sự đồng hành — bởi đổi mới sáng tạo diễn ra nhanh hơn khi cùng lớn mạnh với khách hàng.' }
      }
    }
  },
  en: {
    ...
    soul: {
      ...
      missionPills: ['⚡ Full-Stack Scalable', '🧠 Enterprise AI', '📊 Modern Data Platform'],
      visionPills: ['🌐 Engineering Leader', '🛡️ Private & Secure', '🚀 Sustainable Value'],
      valS: {
        title: 'atisfaction',
    ...
    team: {
      ...
      wwb: {
        ...
        valA: { tag: 'Technology for everyone', desc: 'We believe every business — no matter its size — deserves access to intelligent, modern solutions that accelerate growth and unlock new possibilities.' },
        valP1: { tag: 'Solving real problems', desc: 'We believe in building products that solve real problems, not just create features.' },
        valT: { tag: 'Transparency & Trust', desc: 'We believe in transparency, collaboration, and earning trust through every interaction.' },
        valV: { tag: 'Practical value', desc: 'We believe great technology only matters when it creates real value for real people.' },
        valP2: { tag: 'Long-term partnership', desc: 'We believe in partnership — because innovation happens faster when we grow together with our customers.' }
      }
    }
  }
}
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    try {
      const savedLang = localStorage.getItem('sigma_language') as Language
